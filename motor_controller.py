...
def scan_matrix(repetitions=10, matrix_size=10, step_size=1, start_x_angle=0, start_y_angle=0):
    """
    ...
    time.sleep(0.1)  # Give the emitter some time to move to starting position
